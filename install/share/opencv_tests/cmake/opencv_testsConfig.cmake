...
if("FALSE" STREQUAL "TRUE")
  set(opencv_tests_SOURCE_PREFIX /home/ihack2/ros_wrapper_dev/src/vision_opencv/opencv_tests)
  set(opencv_tests_DEVEL_PREFIX /home/ihack2/ros_wrapper_dev/devel/.private/opencv_tests)
  ...
  set(opencv_tests_INSTALL_PREFIX /home/ihack2/ros_wrapper_dev/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'opencv_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ihack2/ros_wrapper_dev/install/${idir}'.  ${_report}")
    endif()
