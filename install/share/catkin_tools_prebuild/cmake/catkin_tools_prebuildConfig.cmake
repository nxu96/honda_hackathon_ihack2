...
if("FALSE" STREQUAL "TRUE")
  set(catkin_tools_prebuild_SOURCE_PREFIX /home/ihack2/ros_wrapper_dev/build/catkin_tools_prebuild)
  set(catkin_tools_prebuild_DEVEL_PREFIX /home/ihack2/ros_wrapper_dev/devel/.private/catkin_tools_prebuild)
  ...
  set(catkin_tools_prebuild_INSTALL_PREFIX /home/ihack2/ros_wrapper_dev/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ihack2/ros_wrapper_dev/install/${idir}'.  ${_report}")
    endif()
